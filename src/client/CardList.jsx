      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-12 col-md-6 col-lg-4 my-2">
            <ProjectCard image={PersonalSiteImage} alt="Personal Website" cardTitle="Personal Website" tools={['Bootstrap', 'React', 'Node', 'Express']} cardDesc="Personal portfolio website built with React.js + Bootstrap on the frontend and Node.js + Express on the backend." projectUrl="https://github.com/yungnickyoung/personal-site" />
          </div>
          <div className="col-12 col-md-6 col-lg-4 my-2">
          ...
          <div className="col-12 col-md-6 col-lg-4 my-2">
            <ProjectCard image={ReactImage} alt="SmashStats" cardTitle="SmashStats Twitch Extension" tools={['JQuery', 'CSS', 'Flask', 'AWS']} cardDesc="Twitch extension that provides data for player matchups during Super Smash Bros. Melee tournament streams. JQuery + CSS frontend and Flask backend hosted on AWS." projectUrl="https://github.com/yungnickyoung/SmashStats-Melee-Twitch-Extension" />
          </div>
          <div className="col-12 col-md-6 col-lg-4 my-2">
            <ProjectCard image={PersonalSiteImage} alt="VerCare [WIP]" cardTitle="VerCare" tools={['JQuery', 'CSS', 'Flask', 'SQLite']} cardDesc="Website for aggregating hard-to-find hospital data near you. Built with Jquery, CSS, and Flask." projectUrl="" />
          </div>
          <div className="col-12 col-md-6 col-lg-4 my-2">
