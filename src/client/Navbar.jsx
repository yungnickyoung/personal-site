        ...
        <div className="container flex-column flex-md-row">
          <ul className="navbar-nav flex-row">
            <li className="nav-item px-3" key={0}>
              <Navlink isActive={states[0]} text="Projects" onClick={() => { props.onClickTab(0); props.scrollFunc("projects"); }} />
            </li>
            ...
            <li className="nav-item px-3" key={2}>
              <Navlink isActive={states[2]} text="Experience" onClick={() => { props.onClickTab(2); props.scrollFunc("experience"); }} />
            </li>
            <li className="nav-item px-3" key={3}>
              <Navlink isActive={states[3]} text="Contact" onClick={() => { props.onClickTab(3); props.scrollFunc("contact"); }} />
            </li>
          </ul>
