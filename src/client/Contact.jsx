...
export default function Contact(props) {
  return (
    <div style={{backgroundColor: 'white'}}>
      ...
      <div className="row justify-content-center">
        <div className="col justify-content-center text-center wow fadeIn" data-wow-delay="1.2s">
          <div className="px-md-4 pb-3 wow fadeInLeft" data-wow-delay=".7s" data-wow-duration="1s">
            Let's get in touch! 
            <br /> 
